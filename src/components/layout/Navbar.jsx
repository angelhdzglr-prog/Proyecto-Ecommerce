  ...
  return (
    <>
      <nav className="flex items-center justify-between gap-4 border-b border-border bg-white px-3 py-4 md:px-6">
        ...
        <div
          onClick={() => navigate('/')}
          className="h-[40px] w-[120px] shrink-0 cursor-pointer bg-[url('/src/assets/Logo-1.webp')] bg-cover bg-center md:h-[55px] md:w-[155px] max-[965px]:h-[45px] max-[965px]:w-[45px] max-[767px]:bg-[url('/src/assets/LogoSmall.webp')]"
        />
